...
const happySad = (x) => {return new Promise((resolve,reject) => {
...
const amIYourFather = (value) => {return new Promise((resolve,reject) => {
...
const myNameIs = () => {return new Promise(resolve => resolve((name => `My name is ${name}`))) };
