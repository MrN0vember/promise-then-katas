...
const food = () => {return fetch("food").then((response) => response.data)};
...
const cat = () => {return fetch("cats").then((response) => response.data.cats.sort())};
...
const dog = () => {return fetch("dogs").then((response) => {
